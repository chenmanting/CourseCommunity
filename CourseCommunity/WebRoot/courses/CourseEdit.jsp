...
<body>
<form name="form1" method="post" action="courses/editCourse.action" id="form1" enctype="multipart/form-data">
                ...
                <td valign="top" bgcolor="#FFFFFF">
                    <table border="0" width="100%" cellspacing="5" cellpadding="0">
                        <tr>
                            ...
                            <td width="27%"><input name="title" type="text" maxlength="30" id="txtFullName" tabindex="2" class="input" style="width:200px;" value="${editCourse.title}" /></td>
                            <td width="60%">限30个字符以内。</td>
                        </tr>
                        <tr>
                            <td align="right">课程类别:&nbsp;</td>
                            <td><select name="classType"  id="classType" type="text" maxlength="30" id="txtCourseType" tabindex="3" class="input" onFocus="" style="width:200px;" >
                        ...
                        <tr>
                            ...
                            <td><select name="college" id="college" type="text" maxlength="30" id="txtCourseCollege" tabindex="3" class="input" onFocus="" style="width:200px;" >
                        ...
                        <tr>
                            ...
                            <td><input name="keyword" type="text" maxlength="30" id="txtCourseKey" tabindex="4" class="input" style="width:200px;" value="${editCourse.keyword}"/></td>
                        ...
                        <tr>
                            ...
                            <td><input name="notes" type="text" value="${editCourse.notes}" maxlength="30" id="txtMoney" tabindex="11" class="input" style="width:200px;" />
                        ...
                        <tr>
                            ...
                            (限800字内)&nbsp;</td>
                            <td colspan="2">
                                <textarea name="briefIntro" rows="2" cols="20" id="txtContent" tabindex="17" class="input" style="height:105px;width:100%;">${editCourse.briefIntro}</textarea></td>
                        </tr>
                        <tr>
                            <td>&nbsp;
                                </td>
...
<script type="text/javascript">
	$(function(){
		...
		var college = "${editCourse.college}";
		if(college != undefined && college != "" & college != null){
			$("#college").val(college);
		}
		
		var isPublic = "${editCourse.isPublic}";
		if(isPublic =="false"){
			$("#rbtnUnPublic").attr("checked","checked");
		}
